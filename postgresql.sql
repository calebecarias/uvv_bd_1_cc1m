...
create role calebe with superuser createdb createrole inherit login replication bypassrls encrypted password '202204309';
\c uvv calebe;
CREATE SCHEMA hr AUTHORIZATION calebe;
CREATE USER "calebe" IDENTIFIED BY '202204309';
GRANT ALL ON . TO calebe@localhost;
...
COMMENT ON TABLE cargos IS 'Contem as informacoes dos cargos dos empregados da empresa';
COMMENT ON COLUMN cargos.id_cargo IS 'Cargo do funcionario, primary key da tabela';
COMMENT ON COLUMN cargos.cargo IS 'Cargo que o funcionario ocupa';
COMMENT ON COLUMN cargos.salario_minimo IS 'Salario minimo que o cargo recebe';
COMMENT ON COLUMN cargos.salario_maximo IS 'Salario maximo que o cargo pode receber';
...
CREATE TABLE regioes (
                ...
                nome VARCHAR(25),
                CONSTRAINT id_regioes PRIMARY KEY (id_regioes)
);
COMMENT ON TABLE regioes IS 'Tabela regiões. Contém os números e nomes das regiões.';
COMMENT ON COLUMN regioes.id_regioes IS 'Primary key da tabela regioes';
COMMENT ON COLUMN regioes.nome IS 'Campo que armazena o nome das regioes';
...
COMMENT ON TABLE paises IS 'Tabela que guarda as informacoes referentes aos paises';
COMMENT ON COLUMN paises.id_pais IS 'Primary key da tabela paises';
COMMENT ON COLUMN paises.nome IS 'Campo que armazena o nome do pais';
COMMENT ON COLUMN paises.id_regioes IS 'Foreign key da tabela regioes';
...
COMMENT ON TABLE localizacoes IS 'Tabela que contem o endereco dos departamentos da empresa ';
COMMENT ON COLUMN localizacoes.id_localizacao IS 'Primary key da tabela localizacoes';
COMMENT ON COLUMN localizacoes.endereco IS 'Endereco da empresa';
COMMENT ON COLUMN localizacoes.cep IS 'Campo que guarda o cep da localizacao de um departamento da empresa';
COMMENT ON COLUMN localizacoes.cidade IS 'Guarda o nome da cidade da empresa';
COMMENT ON COLUMN localizacoes.uf IS 'Estado onde esta localizado o escritorio da empresa';
COMMENT ON COLUMN localizacoes.id_pais IS 'Foreign key da tabela paises';
...
COMMENT ON TABLE departamentos IS 'Tabela que guarda as informacoes de cada departamento da empresa';
COMMENT ON COLUMN departamentos.id_departamento IS 'Primary key da tabela departamento';
COMMENT ON COLUMN departamentos.nome IS 'Nome do departamento';
COMMENT ON COLUMN departamentos.id_localizacao IS 'Foreign key da tabela localizacoes';
COMMENT ON COLUMN departamentos.id_gerente IS 'Foreign key da tabela empregado como gerente';
...
COMMENT ON TABLE empregados IS 'Tabela com as informacoes dos empregados e gerentes';
COMMENT ON COLUMN empregados.id_empregado IS 'Primary key da tabela empregado';
COMMENT ON COLUMN empregados.nome IS 'Campo com o nome de cada empregado';
COMMENT ON COLUMN empregados.email IS 'email do empregado';
COMMENT ON COLUMN empregados.telefone IS 'Telefone de cada empregado';
COMMENT ON COLUMN empregados.data_contratacao IS 'Data da contratacao do funcionario';
COMMENT ON COLUMN empregados.id_cargo IS 'Cargo do funcionario, primary key da tabela';
COMMENT ON COLUMN empregados.salario IS 'Campo que guarda o salario que cada funcionario recebe';
COMMENT ON COLUMN empregados.comissao IS 'Campo que guarda a comissao dos empregados';
COMMENT ON COLUMN empregados.id_departamento IS 'Foreign key da tabela departamento';
COMMENT ON COLUMN empregados.id_supervisor IS 'Id gerente, criado pelo auto relacionamento';
...
COMMENT ON TABLE historico_cargos IS 'Contem o historico de cada cargo';
COMMENT ON COLUMN historico_cargos.data_inicial IS 'Data inicial do cargo ';
COMMENT ON COLUMN historico_cargos.id_empregado IS 'Primary Key com a Foreign Key ';
COMMENT ON COLUMN historico_cargos.data_final IS 'Data final do cargo';
COMMENT ON COLUMN historico_cargos.id_cargo IS 'Foreign key da tabela cargo';
COMMENT ON COLUMN historico_cargos.id_departamento IS 'Foreign key da tabela departamento';
