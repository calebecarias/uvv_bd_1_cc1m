/* mysql -u root -pcomputacao@raiz
 * CREATE USER 'calebe'@'localhost' IDENTIFIED BY 'matricula'
 * GRANT ALL PRIVILEGES on * . * to 'calebe'@'localhost'
 * FLUSH PRIVILEGES; */
...
ALTER TABLE cargos COMMENT 'Contem as informacoes dos cargos dos empregados da empresa';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Cargo do funcionario, primary key da tabela';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'Cargo que o funcionario ocupa';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'Salario minimo que o cargo recebe';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'Salario maximo que o cargo pode receber';
...
ALTER TABLE regioes MODIFY COLUMN id_regioes INTEGER COMMENT 'Primary key da tabela regioes';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Campo que armazena o nome das regioes';
...
ALTER TABLE paises COMMENT 'Tabela que guarda as informacoes referentes aos paises';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'Primary key da tabela paises';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Campo que armazena o nome do pais';

ALTER TABLE paises MODIFY COLUMN id_regioes INTEGER COMMENT 'Foreign key da tabela regioes';
...
ALTER TABLE localizacoes COMMENT 'Tabela que contem o endereco dos departamentos da empresa ';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'Primary key da tabela localizacoes';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'Endereco da empresa';

ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'empresa';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Guarda o nome da cidade da empresa';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Estado onde esta localizado o escritorio da empresa';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'Foreign key da tabela paises';
...
ALTER TABLE departamentos COMMENT 'Tabela que guarda as informacoes de cada departamento da empresa';

ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'Primary key da tabela departamento';

ALTER TABLE departamentos MODIFY COLUMN nome VARCHAR(50) COMMENT 'Nome do departamento';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'Foreign key da tabela localizacoes';

ALTER TABLE departamentos MODIFY COLUMN id_gerente VARCHAR COMMENT 'Foreign key da tabela empregado como gerente';


CREATE TABLE empregados (
                id_empregado VARCHAR NOT NULL,
...
ALTER TABLE empregados COMMENT 'Tabela com as informacoes dos empregados e gerentes';

ALTER TABLE empregados MODIFY COLUMN id_empregado VARCHAR COMMENT 'Primary key da tabela empregado';

ALTER TABLE empregados MODIFY COLUMN nome VARCHAR(75) COMMENT 'Campo com o nome de cada empregado';

ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'email do empregado';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'Telefone de cada empregado';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Data da contratacao do funcionario';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Cargo do funcionario, primary key da tabela';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Campo que guarda o salario que cada funcionario recebe';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Campo que guarda a comissao dos empregados';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'Foreign key da tabela departamento';

ALTER TABLE empregados MODIFY COLUMN id_supervisor VARCHAR COMMENT 'Id gerente, criado pelo auto relacionamento';
...
ALTER TABLE historico_cargos COMMENT 'Contem o historico de cada cargo';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'Data inicial do cargo ';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado VARCHAR COMMENT 'Primary Key com a Foreign Key ';

ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'Data final do cargo';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Foreign key da tabela cargo';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'Foreign key da tabela departamento';
...
INSERT INTO regioes (id_regioes, nome) VALUES
(1, 'Europe');
INSERT INTO regioes (id_regioes, nome) VALUES
(2, 'Americas');
INSERT INTO regioes (id_regioes, nome) VALUES
...
INSERT INTO paises (id_paises, nome, id_regioes) VALUES
(AR, 'Argentina',
2);
INSERT INTO paises (id_paises, nome, id_regioes) VALUES
(AU, 'Australia',
